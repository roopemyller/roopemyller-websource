...
const GITHUB_CONTRIBUTIONS_LAST_YEAR = 334;

// Round down to a clean approximate figure so the stat reads "300+" rather than an oddly exact "334".
  ...
  return (
    <section className={styles.stats} id="stats" aria-label="Developer stats">
      <SectionReveal className={styles.grid}>
        <StatCounter
          value={roundDown(GITHUB_CONTRIBUTIONS_LAST_YEAR, 100)}
          suffix="+"
